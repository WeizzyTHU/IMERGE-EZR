"""处理导出后的parcel数据, 输出一个总表, 每个年份都有"""
import pandas as pd
from collections import defaultdict
import csv

path = '/Users/weizzy/Desktop/Kaijing模型/模型输出/所有企业-1.028/parcel_params.csv'
output_path = '/Users/weizzy/Desktop/Kaijing模型/模型输出/所有企业-1.028/'
...
parcel_params_file = open(output_path + 'parcel_params_加总.csv', 'w', newline='')
